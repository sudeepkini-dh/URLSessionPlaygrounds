...
extension URLSession {
  static func injectNetworkLayer() {
    ...
    // as they are not avaible to objc runtime
    // Native Swift swizzling (https://www.guardsquare.com/blog/swift-native-method-swizzling) 
    // doesn't work either as it requires the
    // functions to be marked
    // @dynamic and we can't do that to functions
    // defined inside Foundation
    //
